...
//
// export const ChangeStatusSubmit = (id, data, basePath) => ({
//     type: REVIEW_APPROVE,
//     payload: { id, data: { ...data, status: basePath }, basePath },
//     meta: { resource: 'uploadNotificationFile', fetch: UPDATE, cancelPrevious: false },
// });

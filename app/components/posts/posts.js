...
export const PostList = (props) => (
    <List {...props} perPage={25} title="トップページ">
        <Datagrid rowStyle={rowStyle}>
            ...
            <TextField source="title" label = "タイトル" style={{ maxWidth: '18em', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}/>
            {/*<Status/>*/}
...
export const PostCreate = (props) => (
    ...
    <Create {...props}>
        <SimpleForm>
            ...
            <CheckboxGroupInput source="category" label ="通知対象" choices={[
                ...
                <SelectInput source="author_id" label = "通知エリア" choices={[
                    { id: '1', name: 'サイド' },
                    { id: '2', name: 'モーダル' },
                    { id: '3', name: 'ポップアップ' },
                ]} />
            <TextField source ="" label="掲載情報" style={{ font: 'italic bold 12px/30px Georgia, serif'}}/>
            ...
            <TextInput source="title" label= "ボタンテキスト" />
            <TextInput source="title" label= "リンク URL" />
